(function(root, factory) {
    ...
    function setPosition(element,o)
    {
        ...
        if(o.position == 'around' && o.clickEvent != null)
        {
            ...
            let targetX = targetRect.left + window.scrollX;
            let targetY = targetRect.top + window.scrollY;
            let targetW = targetRect.width;
            let targetH = targetRect.height;

            // right default
            //x= targetX + targetW + space;
            //if(targetX + targetW + space + elmWidth > screenWidth) x= targetX - elmWidth - space;
